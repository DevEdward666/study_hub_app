...
const apiBaseUrl = import.meta.env.VITE_API_BASE_URL || "https://studyhubapi-i0o7.onrender.com/api";
...
try {
  ...
  baseUrl = import.meta.env.VITE_API_BASE_URL || "https://studyhubapi-i0o7.onrender.com/api";
}
